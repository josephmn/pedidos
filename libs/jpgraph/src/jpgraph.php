...
class Grid {
    ...
    protected $show=true, $showMinor=false,$majorweight=1,$minorweight=1;
    protected $fill=true,$fillcolor=array('#ffffff','#ffffff');
